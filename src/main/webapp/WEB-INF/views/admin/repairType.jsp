...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            <h3>Управление категорией <span class="label label-default">Услуги</span></h3>
            ...
            <table class="table table-striped">
                ...
                <c:forEach items="${repairTypes}" var="rt">
                    <tr>
                        ...
                        <td>${rt.name}</td>
                        <td>
                            <a href="/admin/category/repairType/edit?id=${rt.id}" class="btn btn-warning">Редактировать</a>
